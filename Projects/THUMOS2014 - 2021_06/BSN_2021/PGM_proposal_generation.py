# -*- coding: utf-8 -*-
"""
Created on Wed Mar 15 14:11:15 2017
This code is used for analysing the distribute of IoU and IoA
@author: wzmsl
"""
import numpy as np
import pandas as pd
...
for videoName in videoNameList:
    ...
    tem_df=pd.read_csv("./output/TEM_results/"+videoName+".csv")
    
    frame_list = tem_df.frame.values[:]
    start_scores = tem_df.start.values[:]
    end_scores = tem_df.end.values[:]
    ...
    new_df.to_csv("./output/PGM_results/"+videoName+".csv",index=False)
